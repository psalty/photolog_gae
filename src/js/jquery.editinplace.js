...
$.fn.editInPlace.defaults = {
	...
	text_size:			25, // integer: set cols attribute of text input, if field_type is set to text. Use CSS if possible though
...
$.extend(InlineEditor.prototype, {
	...
	restoreOriginalValue: function() {
        ...
        {
            this.setClosedEditorContent(this.settings.default_text);
        }
	},
	...
	replaceContentWithEditor: function() {
		var buttons_html  = (this.settings.show_buttons) ? '<div style="text-align:right;padding-right:15px;">'+this.settings.save_button + ' ' + this.settings.cancel_button : ''+'</div>';
	...
	createEditorElement: function() {
		...
		if ("select" === this.settings.field_type)
			...
			editor = $('<input type="text" MAXLENGTH=50 ' + this.inputNameAndClass() 
